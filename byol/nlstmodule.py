...
from .transforms import RandomResizedCrop, CenterCrop
from torchio import transforms as transform_lib

class NLSTDataModule(LightningDataModule):
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.dims = (3, self.image_size, self.image_size, self.image_size)
    ...
    def train_transform(self) -> Callable:
        ...
        preprocessing = transform_lib.Compose(
            [
                ...
                transform_lib.RandomFlip(axes=('lr', 'ap'), flip_probability=0.5),
                transform_lib.ZNormalization(),
            ]
        )
